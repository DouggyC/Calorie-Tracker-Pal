...
let ListComponent = class ListComponent {
    constructor(mockDataService) {
        this.mockDataService = mockDataService;
        this.intake_list$ = this.mockDataService.intake_list$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(a => console.log(a)));
    }
    ngOnInit() { }
};
...
let MacrosComponent = class MacrosComponent {
    constructor(mockDataService) {
        ...
        this.consumed_cal = this.mockDataService.intake_list$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["mergeMap"])((arr) => Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["from"])(arr).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["defaultIfEmpty"])(0), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["pluck"])('nf_calories'), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["reduce"])((acc, cal) => acc + cal), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(cal => Math.round(cal)))));
        this.breakfast_cal = this.mockDataService.intake_list$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["mergeMap"])((arr) => Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["from"])(arr).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["defaultIfEmpty"])(0), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["filter"])((m) => m.meal_type === 'breakfast'), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["pluck"])('nf_calories'), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["reduce"])((acc, cal) => acc + cal), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(cal => Math.round(cal)))));
        this.lunch_cal = this.mockDataService.intake_list$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["mergeMap"])((arr) => Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["from"])(arr).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["defaultIfEmpty"])(0), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["filter"])((m) => m.meal_type === 'lunch'), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["pluck"])('nf_calories'), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["reduce"])((acc, cal) => acc + cal), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(cal => Math.round(cal)))));
        this.dinner_cal = this.mockDataService.intake_list$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["mergeMap"])((arr) => Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["from"])(arr).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["defaultIfEmpty"])(0), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["filter"])((m) => m.meal_type === 'dinner'), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["pluck"])('nf_calories'), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["reduce"])((acc, cal) => acc + cal), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(cal => Math.round(cal)))));
        this.snack_cal = this.mockDataService.intake_list$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["mergeMap"])((arr) => Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["from"])(arr).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["defaultIfEmpty"])(0), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["filter"])((m) => m.meal_type === 'snack'), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["pluck"])('nf_calories'), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["reduce"])((acc, cal) => acc + cal), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(cal => Math.round(cal)))));
...
let SearchComponent = class SearchComponent {
    constructor(searchFoodService) {
        this.searchFoodService = searchFoodService;
        this.searchTerms = new rxjs__WEBPACK_IMPORTED_MODULE_2__["Subject"]();
        this.foods$ = this.searchTerms.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["debounceTime"])(200), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["distinctUntilChanged"])(), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])((term) => this.searchFoodService.searchFood(term)));
    }
    searchFood(term) {
...
let MockDataService = class MockDataService {
    constructor() {
        ...
        this.daily_goal$ = this.DataSource$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["pluck"])('daily_goal'), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(a => console.log(typeof a)));
...
let SearchFoodService = class SearchFoodService {
    constructor(http) {
        this.http = http;
    }
    searchFood(term) {
        ...
        return this.http
            ...
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(a => console.log(a)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(a => [a]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(a => console.log(a)));
    }
};
SearchFoodService.ctorParameters = () => [
